...
1. **Create Failing Test Case**
   ...
   - Use the `ottopowers-gh:test-driven-development` skill for writing proper failing tests
...
**Related skills:**
- **ottopowers-gh:test-driven-development** - For creating failing test case (Phase 4, Step 1)
- **ottopowers-gh:verification-before-completion** - Verify fix worked before claiming success
